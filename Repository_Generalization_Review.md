...
> `Agent Skills/skill-design`, `$skill-creator` 등의 지식을 활용해서
...
`Agent Skills/skill-design/prompts/design-principles.md`는
...
- `Agent Skills/skill-design/prompts/design-principles.md`
