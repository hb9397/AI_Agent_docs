...
- `Harness_Engineering_v2.md`는 `design-doc OUTPUT_V2`를 중심 허브로 놓고 `context-doc`, `impl-fe-be-doc`, `impl-doc`, `design-prototype-docs`로 이어지는 데이터 계약을 비교적 잘 설명한다.
...
- FE/BE 페어 작업지침은 `impl-fe-be-doc`, 범용 구현 계획은 `impl-doc`로 계속 분리해서 설명해야 한다.
