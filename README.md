...
```text
# 1. 프로젝트 상위 폴더(또는 프로젝트 루트)에서 이 저장소를 clone
git clone <이 저장소 URL>
...
`harness-setup`이 단일/복수 프로젝트를 자동 판별하고, `.claude/skills`·`.agents/skills`에 스킬을 설치하며, `.docs/` 구조를 초기화한다. 이후 업데이트도 같은 명령으로 수행한다.
